...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(softwarica));
        ...
        MarkerOptions markerOptions1 = new MarkerOptions().position(dillibazar).title("My skincare cosmetics in dillibazar pipolbot").snippet("").icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.store)));
        mMap.addMarker(markerOptions1);

        LatLng pipalbot = new LatLng(25.566170,86.898041);
        MarkerOptions markerOptions2 = new MarkerOptions().position(pipalbot).title("My Skincare cosmetics in pipalbot").snippet("").icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.store)));
